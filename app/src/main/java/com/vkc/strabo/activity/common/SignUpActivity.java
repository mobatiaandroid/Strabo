...
public class SignUpActivity extends Activity implements View.OnClickListener, VKCUrlConstants {
    ...
    private void initUI() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SignUpActivity.this, R.layout.item_spinner, userTypeList);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position > 0) {
                    ...
                    if (userTypeList.get(position).equals("Retailer")) {
                        ...
                        userType = "7";
                    } else if (userTypeList.get(position).equals("Dealer")) {
                        userType = "6";
                    }
...
//wdhfj
                            ...
                            if (successResponse != null) {
                                ...
                                try {
                                    ...
                                    if (objStateArray.length() > 0) {
                                        ...
                                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SignUpActivity.this, R.layout.item_spinner, listState);
                            ...
                            if (successResponse != null) {
                                ...
                                try {
                                    ...
                                    if (objDistArray.length() > 0) {
                                        ...
                                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SignUpActivity.this, R.layout.item_spinner, listDistrict);
                            ...
                            if (successResponse != null) {
                                ...
                                try {
                                    ...
                                    if (status.equalsIgnoreCase("Success")) {
                                        ...
                                        DialogConfirm dialogCon = new DialogConfirm(mContext, "4", "Registration request submitted successfully. Please login to loyalty app after the confirmation from VKC Group.");
                                        dialogCon.show();
                                    } else if (status.equalsIgnoreCase("Exists")) {


                                        DialogConfirm dialogCon = new DialogConfirm(mContext, "5", "Registration request already submitted. Please contact VKC Group.");
                                        dialogCon.show();
                                    } else {
                                        CustomToast toast = new CustomToast(mContext);
                                        toast.show(0);
    ...
    public void verifyOTP(String otp, String mobile) {
        try {
            ...
            String[] values = {otp, AppPrefenceManager.getUserType(mContext), AppPrefenceManager.getCustomerId(mContext), mobile, "0"};
                                ...
                                try {
                                    ...
                                    if (status.equalsIgnoreCase("Success")) {
                                        ...
                                        if (AppPrefenceManager.getLoginStatusFlag(mContext).equals("yes")) {
                                            ...
                                            if (editCustomer.getText().toString().trim().equals("") && !AppPrefenceManager.getUserType(mContext).equals("6")) {
    ...
    public class DialogConfirm extends Dialog implements
        ...
        public DialogConfirm(Activity a, String type, String message) {
            super(a);
            this.type = type;
    ...
    public class DialogUpdate extends Dialog implements
        ...
        public DialogUpdate(Activity a, String type, String message) {
            super(a);
            this.type = type;
            this.message = message;
            // TODO Auto-generated constructor stub
