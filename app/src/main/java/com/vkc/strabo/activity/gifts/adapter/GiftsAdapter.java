...
public class GiftsAdapter extends RecyclerView.Adapter<GiftsAdapter.MyViewHolder> implements VKCUrlConstants {
    ...
    public GiftsAdapter(Activity context, List<GiftsModel> gifts, TextView textCart, TextView textBalance, TextView textTotal) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Picasso.with(mContext).load(gift_name).transform(new MaskTransformation(mContext,R.drawable.india)).resize(300,300).centerInside().into(holder.image);
