        ...
        spinnerVoucher.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position > 0) {
                    ...
                    textCoupon.setText(listVouchers.get(position - 1).getCoupon_value() + " Coupons");
                                    ...
                                    if (status.equalsIgnoreCase("Success")) {
                                        ...
                                        if (voucherArray.length() > 0) {
                                            ...
                                            for (int i = 0; i < listVouchers.size(); i++) {
                                                listVoucher.add(listVouchers.get(i).getVoucher_value() + " ( " + listVouchers.get(i).getCoupon_value() + " Coupons )");
                                            }
